...
**Viabilidad.** El alcance está acotado a un **MVP realista** (proyectos de software, notificaciones in-app, autenticación por correo, una sola llamada a la IA) y se apoya en tecnologías consolidadas y ampliamente documentadas (Android/Kotlin/Compose, Spring Boot, PostgreSQL). Esto lo hace alcanzable para un equipo de 4 estudiantes en un periodo académico.
