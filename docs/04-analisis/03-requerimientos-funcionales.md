...
- **RF-14 — Validar información suficiente.** El sistema debe verificar que existan los datos mínimos (objetivo general, al menos un requerimiento funcional, una tecnología, fecha de entrega y al menos dos integrantes con perfil) antes de generar la planificación. *(Sistema)*
...
- **RF-20 — Confirmar tareas.** El sistema debe permitir a cada integrante aceptar sus tareas asignadas. *(Integrante)*
- **RF-21 — Solicitar cambios.** El sistema debe permitir a un integrante solicitar cambios sobre sus tareas, indicando un comentario. *(Integrante)*
